...
#' @description Removes the patient from the database indicated. Also updates
#' RDS file of the database
...
delete_patient_cnv <- function(id, n) {
  ...
  } else if (n == "Patients" | n == "patients" | n == "patient") {
