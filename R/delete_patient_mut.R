...
delete_patient_mut <- function(numPaciente, keepXLSX = TRUE) { # Deberia borrar el excel de sus pacientes filtrados? Capaz dejar el VCF nomas
  ...
  # Removes the pateint's XLSX analysis file
  if (keepXLSX == FALSE) {
