#' @title Generation of the graph of the report
#' @description Generates a graph that represents the CNVs detected 
#' @param CNV_calls dataframe generated using AnalyzePatient function. It has the information about the CNVs detected.
#' @param bed is the bedfile that is loaded in this library. You can check it out by coding data("bedfileMito"). It contains information about the 37 genes in the mitochondrial genome
#' @return graph
#' @export 
#' @import ggplot2
#' @import tidyverse
...
plot_cnv <- function(CNV_calls, bed) {
