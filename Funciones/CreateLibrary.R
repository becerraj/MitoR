...
id<-"37019"
bam.control<- "~/Paciente/37019/MitoR/37019_sortedR1R2.bam"
...
#Analyze control patient:
outAnalisis <- analyze_cnv(path_dir = "~/Paciente/46608", transit = 0.7)
PatientsDB <- PatientsDB[,1:4]


#Analyze patient
outAnalisis <- analyze_cnv(path_dir = "~/Paciente/37339", transit = 0.7)
